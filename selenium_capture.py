...
class CaptchaProcess():
    ...
    def get_image(self):  # 对验证码所在位置进行定位，然后截取验证码图片
        img = self.driver.find_element(By.XPATH, '//*[@id="main"]/div/div[2]/div/div/div/div/div[2]/div[1]/div[1]/img')
        time.sleep(2)
    ...
    def move_to_gap(self, distance):  # slider是要移动的滑块,tracks是要传入的移动轨迹
        ...
        self.huakuai = self.driver.find_element(By.CLASS_NAME, "G3AxnX")
